...
#include <renderer/interface/RHI_VK_RESOURCE.hpp>
#include <renderer/interface/RHI_TO_VK_FUNC.hpp>
...
namespace StarryEngine::RHI {
    ...
    public:
        ...
        // 工厂不持有 ResourceManager：句柄由 ResourceManager 解析后，把实际 RHI 对象传进来
        virtual std::unique_ptr<RHIPipeline> createPipeline(
    ...
    public:
        ...
        std::unique_ptr<RHIPipeline> createPipeline(
            const GraphicsPipelineDesc& desc,
            RHIPipelineLayout* layout,
            RHIShaderModule* vertexShader,
            RHIShaderModule* fragmentShader,
