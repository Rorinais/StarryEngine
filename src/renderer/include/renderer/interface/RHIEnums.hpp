...
#define STARRY_DEFINE_BITMASK(E)                                        \
    ...
    hasFlag(E flags, E bit) noexcept {
        return (static_cast<std::underlying_type_t<E>>(flags) &
                static_cast<std::underlying_type_t<E>>(bit)) != 0;
    }
    ...
    STARRY_DEFINE_BITMASK(AccelerationStructureBuildFlags);
    ...
    STARRY_DEFINE_BITMASK(GeometryFlags);
    ...
    STARRY_DEFINE_BITMASK(QueryControlFlags);
    ...
    STARRY_DEFINE_BITMASK(QueryResultFlags);
    ...
    STARRY_DEFINE_BITMASK(ImageSubresourceFlags);
    ...
    STARRY_DEFINE_BITMASK(FormatFeatureFlags);
    ...
    STARRY_DEFINE_BITMASK(ColorComponent);
    ...
    STARRY_DEFINE_BITMASK(PipelineStageFlags2);
    ...
    STARRY_DEFINE_BITMASK(ImageAspect);
    ...
    STARRY_DEFINE_BITMASK(PipelineStage);
    ...
    STARRY_DEFINE_BITMASK(AccessFlag);
    ...
    STARRY_DEFINE_BITMASK(DependencyFlags);
    ...
    STARRY_DEFINE_BITMASK(AccessFlags2);
    ...
    STARRY_DEFINE_BITMASK(ImageCreateFlags);
