...
namespace StarryEngine {
    ...
    VulkanSwapChain::VulkanSwapChain(std::shared_ptr<VulkanDevice> device, VkSurfaceKHR surface, const SwapChainConfig& config)
    ...
    VkResult VulkanSwapChain::present(VkQueue presentQueue,
        uint32_t imageIndex,
    ...
    bool VulkanSwapChain::recreate(uint32_t newWidth, uint32_t newHeight) {
    ...
    bool VulkanSwapChain::createSwapChain(uint32_t width, uint32_t height, VkSwapchainKHR oldSwapchain) {
    ...
    VkCompositeAlphaFlagBitsKHR VulkanSwapChain::pickCompositeAlpha(VkCompositeAlphaFlagsKHR supported, VkCompositeAlphaFlagBitsKHR requested) const {
    ...
    void VulkanSwapChain::printInfo() const {
