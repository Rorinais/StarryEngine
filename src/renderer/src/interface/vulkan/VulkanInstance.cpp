...
namespace StarryEngine {
    ...
    VulkanInstance::Ptr VulkanInstance::create(const Config& config) {
        return std::make_shared<VulkanInstance>(config);
    }

    VulkanInstance::VulkanInstance(const Config& config) : mConfig(config) {
    ...
    VKAPI_ATTR VkBool32 VKAPI_CALL VulkanInstance::debugCallback(
        ...
        auto instance = static_cast<VulkanInstance*>(pUserData);
