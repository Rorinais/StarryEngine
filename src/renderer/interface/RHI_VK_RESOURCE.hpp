...
namespace StarryEngine::RHI {
    ...
    public:
        ...
        void setLayout(std::unique_ptr<RHI_VK_PipelineLayout> layout) {
        ...
        size_t getMemoryUsage() const override {
            return sizeof(*this) + mDesc.debugName.size();
        }

        const char* getTypeName() const override {
            return mType == PipelineType::Graphics ? "VK_GraphicsPipeline" : "VK_ComputePipeline";
        }
        ...
        bool canBeReloaded() const override { return false; } // 暂时不支持
